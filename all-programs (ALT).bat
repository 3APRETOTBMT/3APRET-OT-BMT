...
cd /d "%~dp0"
call service.bat status_3APRETOTBMT
call service.bat check_updates_3APRETOTBMT
echo:

set "BIN=%~dp0bin\"
set "LISTS=%~dp0lists\"

start "all-programs (ALT)" /min "%BIN%3APRETOTBMT.exe" --wf-tcp=80,443 --wf-udp=443,50000-50100 ^
